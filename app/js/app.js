...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            forge.updateSiteDeploymentScript(this.server.id, this.site.id, this.$refs.deployScriptBox.value).then(function (r) {
        ...
        getDeployScript: function getDeployScript(site) {
            ...
            forge.siteDeploymentScript(this.server.id, site.id).then(function (r) {
                console.log(r);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getDeploymentLog: function getDeploymentLog(site) {
            ...
            forge.siteDeploymentLog(this.server.id, site.id).then(function (r) {
                console.log(r);
                _this.loading = false;
                _this.log = r;
            });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deployNow: function deployNow() {
            ...
            this.deploying = true;
            forge.deploySite(this.server.id, this.site.id).then(function (r) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            forge.updateSiteEnvironmentFile(this.server.id, this.site.id, this.env).then(function (r) {
                // this.env = r;
                _this.back();
            });
        },
        getEnv: function getEnv(site) {
            ...
            forge.siteEnvironmentFile(this.server.id, site.id).then(function (r) {
                console.log(r);
                _this2.env = r;
                _this2.saving = false;
            });
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getServers: function getServers(_ref) {
        var commit = _ref.commit,
            dispatch = _ref.dispatch;

        forge.servers().then(function (r) {
    ...
    getServerSites: function getServerSites(_ref2, server) {
        ...
        forge.sites(server.id).then(function (r) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_vm._m(0), _vm._v(" "), _c('div', {
    ...
    staticClass: "panel-heading"
  }, [_vm._v("Account #1")]), _vm._v(" "), _c('ul', {
    staticClass: "list-group"
  }, _vm._l((_vm.filteredList), function(server) {
    return _c('router-link', {
      key: server.id,
      staticClass: "list-item flex",
      attrs: {
