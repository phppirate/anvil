...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vuex_actions_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vuex_getters_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__vuex_mutations_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_forge_sdk__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Job__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Queue__ = __webpack_require__(12);
...
var store = new __WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* default */].Store({
    ...
    actions: __WEBPACK_IMPORTED_MODULE_4__vuex_actions_js__["a" /* default */],
    getters: __WEBPACK_IMPORTED_MODULE_5__vuex_getters_js__["a" /* default */],
...
window.appl = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        getData: function getData() {
            ...
            forgeAccounts.forEach(function (account) {
                _this.$store.dispatch('getServers', account);
            });
        },
        ...
        logIn: function logIn() {
            var apiToken = this.$refs.token.value;
            var name = this.$refs.name.value;
            var data = [{ api_token: apiToken, name: name }];
        ...
        listen: function listen() {
            ...
            window.addEventListener('online', function () {
                return _this2.updateNetworkStatus();
            });
            window.addEventListener('offline', function () {
                return _this2.updateNetworkStatus(false);
            });
...
function mapAccounts(accounts) {
    ...
    return accounts.map(function (a) {
        index++;
        var account = new __WEBPACK_IMPORTED_MODULE_7_forge_sdk__["a" /* default */](a.api_token);
        account.id = index;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        logIn: function logIn() {
            var data = { api_token: this.apiToken, name: this.name };
            accounts.push(data);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        rebootServer: function rebootServer() {
            ...
            this.rebooting = true;
            forge.rebootServer(this.server.id).then(function (r) {
        ...
        rebootMysql: function rebootMysql() {
            ...
            forge.rebootMysql(this.server.id).then(function (r) {
        ...
        rebootNginx: function rebootNginx() {
            ...
            forge.rebootNginx(this.server.id).then(function (r) {
        ...
        rebootPostgres: function rebootPostgres() {
            ...
            forge.rebootPostgres(this.server.id).then(function (r) {
        ...
        stopServer: function stopServer() {
            ...
            this.stoping = true;
            forge.stopServer(this.server.id).then(function (r) {
                _this5.stoping = false;
            });
        },
        stopMysql: function stopMysql() {
            var _this6 = this;

            this.stopingMysql = true;
            forge.stopMysql(this.server.id).then(function (r) {
                _this6.stopingMysql = false;
            });
        },
        stopNginx: function stopNginx() {
            var _this7 = this;

            this.stopingNginx = true;
            forge.stopNginx(this.server.id).then(function (r) {
                _this7.stopingNginx = false;
            });
        },
        stopPostgres: function stopPostgres() {
            var _this8 = this;

            this.stopingPostgres = true;
            forge.stopPostgres(this.server.id).then(function (r) {
                _this8.stopingPostgres = false;
            });
        },
        ...
        openSshInIterm: function openSshInIterm() {
        ...
        openSshInTerm: function openSshInTerm() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        archivedServers: function archivedServers() {
            return this.servers.filter(function (server) {
                return server.revoked;
            });
        },
        serverGroups: function serverGroups() {
            var servers = null;
            if (this.showingArchived) {
                servers = this.servers;
            }
            servers = this.servers.filter(function (server) {
                return !server.revoked;
            });
            var groups = _.groupBy(servers, function (i) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            this.server.account.updateSiteDeploymentScript(this.server.id, this.site.id, this.$refs.deployScriptBox.value).then(function (r) {
                _this.$router.push('/servers/' + _this.server.id + '/sites/' + _this.site.id);
            });
        },
        getDeployScript: function getDeployScript(site) {
            var _this2 = this;

            console.log('SITE', site.id);
            this.server.account.siteDeploymentScript(this.server.id, site.id).then(function (r) {
                console.log(r);
                _this2.deployScript = r;
                _this2.saving = false;
            });
        }
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getDeploymentLog: function getDeploymentLog(site) {
            ...
            site.account.siteDeploymentLog(this.server.id, site.id).then(function (r) {
                console.log(r);
                _this.loading = false;
                _this.log = r;
            });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deployNow: function deployNow() {
            ...
            this.deploying = true;
            this.server.account.deploySite(this.server.id, this.site.id).then(function (r) {
                return _this.deploying = false;
            });
        },
        ...
        editDeployScript: function editDeployScript() {
            this.$router.push('/servers/' + this.server.id + '/sites/' + this.site.id + '/deployment/script');
        },
        shouldGetDeployScript: function shouldGetDeployScript() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            this.server.account.updateSiteEnvironmentFile(this.server.id, this.site.id, this.env).then(function (r) {
                _this.back();
            });
        },
        getEnv: function getEnv(site) {
            var _this2 = this;

            this.server.account.siteEnvironmentFile(this.server.id, site.id).then(function (r) {
                console.log(r);
                _this2.env = r;
                _this2.saving = false;
            });
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getServers: function getServers(_ref, account) {
        var commit = _ref.commit,
            dispatch = _ref.dispatch;

        console.log('Adding Servers: ', account);
        account.servers().then(function (r) {
            var servers = r.map(function (server) {
    ...
    getServerSites: function getServerSites(_ref2, server) {
        var commit = _ref2.commit;

        server.account.sites(server.id).then(function (r) {
            commit('add-sites', r.map(function (site) {
    ...
    toggleQuickDeploy: function toggleQuickDeploy(_ref3, _ref4) {
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = ({
    getServerById: function getServerById(state) {
        return function (id) {
    ...
    getSitesForServer: function getSitesForServer(state) {
        return function (server) {
            return state.sites.filter(function (s) {
                return s.server_id === server.id;
            });
        };
    },
    getSiteById: function getSiteById(state) {
        return function (id) {
            return state.sites.find(function (s) {
                return s.id.toString() === id;
            });
        };
    }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    'set-servers': function setServers(state, servers) {
        var _state$servers;

        (_state$servers = state.servers).push.apply(_state$servers, _toConsumableArray(servers));
    },
    'add-sites': function addSites(state, sites) {
        var _state$sites;

        (_state$sites = state.sites).push.apply(_state$sites, _toConsumableArray(sites));
    },
    ready: function ready(state) {
        state.loading = false;
    },

    'set-site': function setSite(state, site) {
        var theIndex = state.sites.findIndex(function (s) {
            return s.id === site.id;
        });
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/add-account.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] add-account.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d7d7eda8", Component.options)
  } else {
    hotAPI.reload("data-v-d7d7eda8", Component.options)
  }
})()}
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/server-details.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] server-details.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3aff815d", Component.options)
  } else {
    hotAPI.reload("data-v-3aff815d", Component.options)
  }
})()}
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/servers.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7a01a08a", Component.options)
  } else {
    hotAPI.reload("data-v-7a01a08a", Component.options)
  }
})()}
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/site-deployment-edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] site-deployment-edit.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-14f43d1e", Component.options)
  } else {
    hotAPI.reload("data-v-14f43d1e", Component.options)
  }
})()}
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/site-details.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] site-details.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-79242aa1", Component.options)
  } else {
    hotAPI.reload("data-v-79242aa1", Component.options)
  }
})()}
...
Component.options.__file = "/Users/sam/electron/anvil/src/js/pages/site-env-edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] site-env-edit.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65bc229b", Component.options)
  } else {
    hotAPI.reload("data-v-65bc229b", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-14f43d1e", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.server) ? _c('div', {
    staticClass: "titlebar"
  }, [_c('div', {
    staticClass: "backbtn",
    on: {
    ...
    return _c('router-link', {
      ...
      attrs: {
        "tag": "li",
        "to": '/servers/' + _vm.server.id + '/sites/' + site.id
      }
    }, [_c('div', {
      staticClass: "list-item-title"
    }, [_vm._v(_vm._s(site.name))]), _vm._v(" "), _c('div', {
      staticClass: "small",
      domProps: {
    ...
    staticClass: "reboot-services flex-1 mr-1"
  }, [_c('div', {
    staticStyle: {
      "margin-bottom": "10px"
    }
  ...
  }, [_vm._v("Reboot Server")]) : _c('button', {
  ...
  }, [(!_vm.rebootingPostgres) ? _c('button', {
    staticClass: "btn is-success btn-block",
    on: {
    ...
    staticClass: "stop-services flex-1 ml-1"
  }, [_c('div', {
    staticStyle: {
      "margin-bottom": "10px"
    }
  }, [(!_vm.stoping) ? _c('button', {
    staticClass: "btn is-danger btn-block",
    on: {
      "click": _vm.stopServer
    }
  }, [_vm._v("Stop Server")]) : _c('button', {
    staticClass: "btn is-danger btn-block disabled"
  }, [_c('span', {
    staticClass: "fa fa-spinner fa-pulse"
  })])]), _vm._v(" "), _c('div', {
    staticStyle: {
  ...
  }, [(!_vm.stopingMysql) ? _c('button', {
    staticClass: "btn is-danger btn-block",
    on: {
      "click": _vm.stopMysql
    }
  }, [_vm._v("Stop MySQL")]) : _c('button', {
    staticClass: "btn is-danger btn-block disabled"
  }, [_c('span', {
    staticClass: "fa fa-spinner fa-pulse"
  })])]), _vm._v(" "), _c('div', {
  ...
  }, [(!_vm.stopingNginx) ? _c('button', {
    staticClass: "btn is-danger btn-block",
    on: {
      "click": _vm.stopNginx
    }
  }, [_vm._v("Stop NginX")]) : _c('button', {
    staticClass: "btn is-danger btn-block disabled"
  }, [_c('span', {
    staticClass: "fa fa-spinner fa-pulse"
  })])]), _vm._v(" "), _c('div', {
  ...
  }, [(!_vm.stopingPostgres) ? _c('button', {
    staticClass: "btn is-danger btn-block",
    on: {
      "click": _vm.stopPostgres
    }
  }, [_vm._v("Stop Postgres")]) : _c('button', {
    staticClass: "btn is-danger btn-block disabled"
  }, [_c('span', {
    staticClass: "fa fa-spinner fa-pulse"
    ...
    staticClass: "btn btn-block",
    on: {
      "click": _vm.openSshInIterm
    }
  }, [_vm._v("SSH In iTerm")]), _vm._v(" "), _c('button', {
    staticClass: "btn btn-block",
    on: {
      "click": _vm.openSshInTerm
    }
  }, [_vm._v("SSH In Terminal")])])])])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3aff815d", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-65bc229b", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.server) ? _c('div', [(_vm.site) ? _c('div', {
    staticClass: "titlebar"
  }, [_c('div', {
    staticClass: "backbtn",
    on: {
  ...
  }, [_vm._v("Enable Quick Deploy")]) : _c('button', {
    staticClass: "btn is-success btn-block",
    on: {
      "click": _vm.toggleQuickDeploy
    }
  }, [_vm._v("Disble Quick Deploy")])]) : _vm._e()])]), _vm._v(" "), (_vm.site.app != 'WordPress') ? _c('div', {
    staticClass: "panel"
  }, [_c('div', {
    staticClass: "panel-heading"
  }, [_c('div', {
    staticClass: "title"
  }, [_vm._v("Deploy Script")]), _vm._v(" "), _c('div', {
    staticClass: "icon",
    on: {
      "click": _vm.editDeployScript
    }
  }, [_c('span', {
    staticClass: "fa fa-pencil"
  })])])]) : _vm._e(), _vm._v(" "), (_vm.site.app != 'WordPress') ? _c('div', {
    staticClass: "panel"
  }, [_c('div', {
    staticClass: "panel-heading"
  }, [_c('div', {
    staticClass: "title"
  }, [_vm._v("ENV File")]), _vm._v(" "), _c('router-link', {
    staticClass: "icon",
    attrs: {
      "to": '/servers/' + _vm.server.id + '/sites/' + _vm.site.id + '/env'
    }
  }, [_c('span', {
    staticClass: "fa fa-pencil"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-79242aa1", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })])], 1), _vm._v(" "), _vm._l((_vm.serverGroups), function(group, index) {
    return _c('div', {
      staticClass: "panel"
    }, [_c('div', {
      staticClass: "panel-heading"
    }, [_vm._v(_vm._s(index))]), _vm._v(" "), _c('ul', {
      staticClass: "list-group"
    }, _vm._l((group), function(server) {
      return _c('router-link', {
        key: server.id,
        staticClass: "list-item flex",
        attrs: {
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: (server.revoked),
          expression: "server.revoked"
        }],
        staticClass: "fa fa-ban"
      }), _vm._v(" " + _vm._s(server.name))]), _vm._v(" "), _c('div', {
        staticClass: "small"
      }, [_vm._v(_vm._s(server.ip_address))])])
    })), _vm._v(" "), (_vm.archivedServers.length) ? _c('div', {
      staticClass: "panel-body",
      staticStyle: {
        "border-top": "1px solid #efefef"
      }
    }, [_c('button', {
      staticClass: "btn is-primary btn-block",
      on: {
        "click": function($event) {
          _vm.showingArchived = !_vm.showingArchived
        }
      }
    }, [_vm._v(_vm._s(_vm.showingArchived ? 'Hide' : 'Show') + " Archived Servers")])]) : _vm._e()])
  })], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7a01a08a", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "panel-heading"
  }, [_vm._v("New Account Info")]), _vm._v(" "), _c('div', {
    staticClass: "panel-body"
  }, [_c('div', [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "click": function($event) {
        ...
        _vm.openExternal('https://forge.laravel.com/user/profile#/api')
      }
    }
  }, [_vm._v("Get one here")])])]), _vm._v(" "), _c('div', [(!_vm.connecting) ? _c('button', {
    staticClass: "btn is-success btn-block",
    on: {
      "click": _vm.logIn
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-d7d7eda8", module.exports)
  }
}
