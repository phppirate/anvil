...
var baseRequest = function baseRequest(method, path, token) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__routes_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vuex_actions_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vuex_getters_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__vuex_mutations_js__ = __webpack_require__(13);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            forge.saveDeployScriptForSite(this.site, this.$refs.deployScriptBox.value).then(function (r) {
        ...
        getDeployScript: function getDeployScript(site) {
            ...
            forge.getDeployScriptForSite(site).then(function (r) {
                console.log(r);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save() {
            ...
            this.saving = true;
            forge.saveEnvForSite(this.site, this.env).then(function (r) {
                _this.env = r;
            });
        },
        getEnv: function getEnv(site) {
            ...
            forge.getEnvForSite(site).then(function (r) {
                console.log(r);
                _this2.env = r;
                _this2.saving = false;
            });
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getServers: function getServers(_ref) {
        ...
        forge.getServers().then(function (r) {
    ...
    getServerSites: function getServerSites(_ref2, server) {
        ...
        forge.getSites(server).then(function (r) {
            commit('add-sites', r.sites.map(function (site) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Disble Quick Deploy")])]) : _c('div', {
    staticClass: "text-center"
  }, [_c('h3', [_c('span', {
    staticClass: "fa fa-wordpress"
  }), _vm._v(" WordPress Site")])])])]), _vm._v(" "), (_vm.site.app != 'WordPress') ? _c('div', {
    staticClass: "panel"
  }, [_c('div', {
    staticClass: "panel-heading"
  }, [_c('div', {
